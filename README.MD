...
- Aplicación desplegada: proyecto-m3-ia-chat.vercel.app
...
También se puede crear un `.env.example` con:
...
![Astra](./screenshots/AstraChat.png)

### Chat con Gojo

![Gojo](./screenshots/ChatGojo.png)
